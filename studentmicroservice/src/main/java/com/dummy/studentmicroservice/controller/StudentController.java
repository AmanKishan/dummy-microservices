...
import com.dummy.studentmicroservice.configuratuion.StudentCloudConfig;
...
public class StudentController {
	...
	@Autowired
	private StudentCloudConfig configuration;
	 ...
	 private static Map<String, List<Student>> schooDB = new HashMap<>();
	    ...
	    public List<Student> getStudents(@PathVariable String schoolname) {
	        ...
	        System.out.println("configuration is coming " + configuration);
